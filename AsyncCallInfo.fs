...
// We require an euality check that does deep equality for all the possible parameter types
// The default F# structural equality might be good enough
type AsyncCallInfo = 
    {
        FunctionName: string
        Arguments: obj
...
let Create(functionName: string, parameters: obj) = { FunctionName = functionName; Arguments = parameters }
